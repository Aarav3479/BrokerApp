...
public ConsumerFactory<String, TradePlacedEvent> tradeConsumerFactory() {
    ...
    props.put(ConsumerConfig.GROUP_ID_CONFIG, "portfolio-service");
...
@Bean
public ConcurrentKafkaListenerContainerFactory<String, TradePlacedEvent> kafkaListenerContainerFactory() {
